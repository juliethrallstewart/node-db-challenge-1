...
A Relational Database is made of tables and columns, forming relationships
through foreign keys.

SQL is the query language that is used to access the database.

- [ ] Why do tables need a `primary key`?

Tables need a primary key so that they can be uniquely indentified.
...
a table that is made of two different tables and can have a relationship with many items on either tables.
